...
namespace Property
{
    public partial class HomeMaster : System.Web.UI.MasterPage
    {
        ...
        public void GetExclusiveListing()
        {
            ...
            //if (dt.Rows.Count > 0)
            //{
            //    exclusive_repeater.DataSource = dt;
            //    exclusive_repeater.DataBind();
            //    exclusive_repeater.Visible = true;
            //    MyListing_Slider_Div.Visible = true;
            //    Commingsoon.Visible = false;
            //}
            //else
            //{
            //    exclusive_repeater.Visible = false;
            //    MyListing_Slider_Div.Visible = false;
            //    Commingsoon.Visible = true;
            //}
